...
public record CreateDocumentCommand(
    ...
    public CreateDocumentCommand(File inputFile, File outputFile, TemplateType templateType, String customTemplatePath, DocumentCustomization documentCustomization) {
